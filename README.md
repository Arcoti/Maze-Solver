...
![Sample Solver Output](./static/sample_solver_output.png)

As an extension, this project also contains a maze generation code which generates a maze to be solved. The maze is generated using Wilson's Algorithm, which leverages on the concept of loop erase random walk to generate an unbiased outcome. The maze will then be stored in a binary input file which can be used as the input file of the solver. 

![Sample Generator Output](./static/sample_generator_output.png)
